...
package com.chengzhang.zebracrossing.app.zcrossing.view;
...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        //init the location of middle line
        if(!isFirst){
            isFirst = true;
            lineTop = frame.top;
            lineBottom = frame.bottom;
        }
...
//            canvas.drawRect(frame.left + 2, middle - 1, frame.right - 1, middle + 2, paint);
            ...
            //draw middle line
            paint.setColor(getResources().getColor(R.color.color_corner));
            lineTop += 10;
            if(lineTop >= frame.bottom){
                lineTop = frame.top;
            }
            canvas.drawRect(frame.left + 5, lineTop - 6/3, frame.right - 5,lineTop + 6/3, paint);
            //you can replace the line by your drawable like wei xin
//            Rect lineRect = new Rect();
//            lineRect.left = frame.left;
//            lineRect.right = frame.right;
//            lineRect.top = lineTop;
//            lineRect.bottom = lineBottom + 18;
//            canvas.drawBitmap(((BitmapDrawable)(getResources().getDrawable(R.drawable.qrcode_scan_line))).getBitmap(),

           // the result pointer to show
